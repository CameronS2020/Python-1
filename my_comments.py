...
mpg = distance / tank_size # This formula works because if 15 gallons maxes out at 600 distance traveled, each gallon is used 15 times, leading to 600/15 for a single gallon
